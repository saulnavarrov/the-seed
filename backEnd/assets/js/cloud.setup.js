...
Cloud.setup({
  ...
  "usersRolesListPermits": {
    "verb": "POST",
    "url": "/api/v2/permits",
    "args": []
  },
  "usersRolesCreateRoles": {
    "verb": "POST",
    "url": "/api/v2/roles/create-roles",
    "args": [
      "name"
    ]
  },
  "usersRolesCreatePermits": {
    "verb": "POST",
    "url": "/api/v2/roles/create-permits",
    "args": [
      "role",
      "tipo",
      "acceso",
  ...
  "usersRolesGetUsersRoles": {
    "verb": "POST",
    "url": "/api/v2/roles/get-users-roles",
    "args": []
  },
  "usersRolesChangeUsersRoles": {
    "verb": "PATCH",
    "url": "/api/v2/roles/change-users-roles",
    "args": [
      "userRol",
      "rolUser",
      "change"
